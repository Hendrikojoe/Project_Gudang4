...
<style>
    ...
    /* 🔥 Sembunyikan search bawaan DataTable */
    ...
    /* DataTable Info & Pagination Styling */
...
<div class="container-fluid mt-4">
    <div class="card card-custom p-4">
        ...
        <!-- 🔥 Header dengan Title dan Search Bar sejajar -->
        <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-3">
            ...
            <!-- 🔥 Custom Search Bar - berada di sebelah title page -->
...
<div class="modal fade" id="detailModal" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header" style="background: linear-gradient(90deg, #4e73df, #224abe); color: white;">
                <h5 class="modal-title">
                    <i class="fas fa-info-circle me-2"></i> Detail Transaksi Barang Masuk
                </h5>
...
function showDetail(id) {
    ...
    // Fetch detail data
    fetch(`<?= base_url('barang/masuk/detail') ?>/${id}`)
...
function confirmDelete(id) {
    if (confirm('⚠️ Apakah Anda yakin ingin menghapus transaksi ini?\n\nData yang dihapus tidak dapat dikembalikan!\n\nStok barang akan dikembalikan secara otomatis.')) {
        window.location.href = `<?= base_url('barang/masuk/delete') ?>/${id}`;
    }
}
...
function printDetail() {
    if (currentDetailData) {
        ...
        printWindow.document.write(`
            ...
            <html>
            <head>
                <title>Detail Transaksi Barang Masuk</title>
            ...
            <body>
                <div class="container">
                    <h3 class="text-center mb-4">Detail Transaksi Barang Masuk</h3>
                    ${currentDetailData}
